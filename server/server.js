...
app.post("/login", function (request, response) {
  ...
  if (email && ticket) {
    connection.query(
      "SELECT * FROM accounts WHERE email = ? AND ticket = ?",
      [email, sha512(ticket)],
...
const warningMessage =
  "This is your first warning. Further misbehaving will lead to your removal from the event.";
...
const terminateMessage =
  "Your chat sessions have been terminated by the Admin.";
